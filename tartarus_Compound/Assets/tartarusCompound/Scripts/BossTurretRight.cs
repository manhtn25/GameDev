...
public class BossTurretRight : MonoBehaviour
{
    ...
    float timebetween;
    public float startTimeBetweenBossRight;
    private float bulletSpeed = 400f;

    public bool playerInTurretRangeBossRight = false;
    ...
    void Start()
    {
        timebetween = startTimeBetweenBossRight;
    ...
    void Update()
    {
        ...
        else
        {
            ...
            else if (switchFirst.switchActive == false || switchSecond.switchActive == false)
            {
                ...
                if (playerInTurretRangeBossRight == true && turretDead == false)
                {
